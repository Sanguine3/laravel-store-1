    ...
    <flux:header sticky class="bg-zinc-50 dark:bg-zinc-900 border-b border-zinc-200 dark:border-zinc-700 rounded-md">
        ...
        <div class="flex sm:hidden flex-col px-4 py-2" x-data="{ open: false }">
            <div class="flex items-center justify-between w-full">
                <span class="text-lg font-bold tracking-wide text-indigo-700 dark:text-indigo-300 select-none">Admin TM<sup class='text-xs align-super'>™</sup></span>
        ...
        <flux:navbar class="hidden sm:flex">
            <span class="text-lg font-bold tracking-wide text-indigo-700 dark:text-indigo-300 select-none">Admin Management<sup class='text-xs align-super'>™</sup></span>
            <div class="flex-1"></div>
            <flux:navbar.item :href="route('admin.products')" :current="request()->routeIs('admin.products*')" wire:navigate>
                Products
            </flux:navbar.item>
            <flux:navbar.item :href="route('admin.categories')" :current="request()->routeIs('admin.categories*')" wire:navigate>
                Categories
            </flux:navbar.item>
            <flux:navbar.item :href="route('admin.orders')" :current="request()->routeIs('admin.orders*')" wire:navigate>
                Orders
            </flux:navbar.item>
